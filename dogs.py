#Name: Leo Torres
#Program Purpose: This program demonstrates how to manipylate a list, including:
#   finding number of items in the list, sorting the list, adding/removing items,
#   copying a list of items into another list, and changing the data in the lsit.
...
def main(): 
    ...
    print("Pop a dog off with position 3 (which is the 4th dog) in the list:")
    print(dogs)
